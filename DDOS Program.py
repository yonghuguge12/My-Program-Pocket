...
#This is a DDOS IP attack  Python program.
#All responsibilities will be borne by the user, and the program is guaranteed to be available in your country/region!
#Please use this program on Python 2.x version!
version= '2.0'
title = '''
      _ \        __ \  __ \               ___|           _)       |   
